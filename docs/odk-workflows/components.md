...
1) Locate your odk yaml file and open it with your favourite text editor (src/ontology/ak-ontology-odk.yaml)
...
```
  <uri name="http://purl.obolibrary.org/obo/ak-ontology/components/your-component-name.owl" uri="components/your-component-name.owl"/>
```

4) Add the component to the edit file (src/ontology/ak-ontology-edit.obo)
for .obo formats: 

```
import: http://purl.obolibrary.org/obo/ak-ontology/components/your-component-name.owl
```
...
6) In your custom makefile (src/ontology/ak-ontology.Makefile) add a goal for your custom make file. In this example, the goal is a ROBOT template.
