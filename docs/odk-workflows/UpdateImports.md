...
To enable this workflow, you add the following to your ODK config file (`src/ontology/ak-ontology-odk.yaml`), and [update the repository](RepoManagement.md):
...
To check if your ontology uses this method, check src/ontology/ak-ontology-odk.yaml to see if `use_base_merging: TRUE` is declared under `import_group`
