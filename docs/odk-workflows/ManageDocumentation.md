...
The documentation for AK-ONTOLOGY is managed in two places (relative to the repository root):
...
2. Now you are ready to build the docs as follows:
   ...
   ```
   INFO    -  Your documentation should shortly be available at: https://airr-knowledge.github.io/ak-ontology/ 
   ```
3. Just to double check, you can now navigate to your documentation pages (usually https://airr-knowledge.github.io/ak-ontology/). 
